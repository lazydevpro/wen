...
export const LADDER_BY_COLUMN = [
    [3, 7.1, 25.5, 50.3, 66.6, 98.3],
    [3.3, 9.8, 14.6, 20.4, 98.3, 98.3],
    [3.9, 6.9, 17.1, 17.1, 50.3, 187.6],
    [4.3, 6.9, 17.1, 17.1, 40.5, 250],
    [4.3, 8.6, 13.7, 15.8, 50.3, 98.3],
    [4.6, 11.4, 11.4, 14.6, 40.5, 50.3],
    [5.3, 8.2, 11.4, 11.4, 40.5, 50.3],
    [5, 10.8, 12.1, 20.4, 22.7, 33.8],
];
